    ...
    <div className="bg-[#161A20] text-[#9FB1D1] font-poppins-custom">
      ...
      <nav className="flex flex-col md:flex-row justify-between items-center gap-10  py-10">
        ...
        <div className="md:w-1/2 px-16">
          <h1 className="text-4xl md:text-5xl font-lexend-giga-custom mb-4 text-[#C3D0E5]">Let's talk</h1>
        ...
        <div className="md:w-1/2 space-y-5 pl-[200px]">
          <div className="flex gap-5">
            <div className="font-semibold w-20 text-[#C3D0E5]">Email</div>
            <div>Evenza123@gmail.com</div>
          </div>
          <div className="flex gap-5">
            <div className="font-semibold w-20  text-[#C3D0E5]">Phone</div>
            <div>(+65) 98735984</div>
          </div>
          <div className="flex gap-5">
            <div className="font-semibold w-20  text-[#C3D0E5]">Address</div>
            <div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center py-4 text-sm text-gray-400 ">
        <span className='pl-16'>
          © 2025 <a href="#" className="hover:underline text-[#C3D0E5]">Evenza</a>. All Rights Reserved.
        </span>
