...
const vendorSignupController = async (req, res) => {
  try {
    ...
    const { name, email, password, category, price, experience, role } = req.body;
...
module.exports = { userLoginController , vendorLoginController, userSignupController, vendorSignupController };
